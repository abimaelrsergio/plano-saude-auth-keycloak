...
public class SecurityConfig {
	...
	SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, HandlerMappingIntrospector introspector)
		...
		return httpSecurity
				.authorizeHttpRequests(auth -> auth
						...
						.requestMatchers(PathRequest.toH2Console()).permitAll() // h2-console não recomendando em produção
	...
	KeyPair keyPair() {
		try {
			...
			throw new IllegalStateException("Impossível gerar o par de chaves RSA", e);
		}
	}	
